...
public class Controller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("home")) {
            ...
            User spartan = new User(0, name, helmet, body, visor, notes);
            System.out.println("Controller:createRecord:user=" + spartan);

            // validate the parameters
            if (name == null || helmet == null || body == null || visor == null
                    || name.isEmpty() || helmet.isEmpty() || body.isEmpty() || visor.isEmpty()) {
                url = "/createRecord.jsp";
            } else {
                // insert this data record into the database
                DAOSQLite.createRecord(spartan, dbPath);
                url = "/home.html";
            }
            ...
            List<User> mydata = DAOSQLite.retrieveRecords(dbPath, name);
